# Recovery Tree for Xiaomi Redmi Note 12R/Redmi 12 5G/POCO M6 Pro 5G (Sky/River)
...
### Clone & Sync Source
```
mkdir -p ~/OrangeFox_XXX
cd ~/OrangeFox_XXX
git clone https://gitlab.com/OrangeFox/sync.git
cd sync
./orangefox_sync.sh --branch XXXX --path ~/fox_XXXX
```
### Clone Device-tree
```
cd ~/fox_XXXX/device
mkdir -p sky
cd sky
git clone https://github/device_xiaomi_recovery_tree.git
```
### BUILD!
```
cd ~/fox_XX
